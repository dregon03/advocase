...
export const lobbyistRegistrations: LobbyistRegistration[] = [
  ...
  {
    lobbyistName: "Karen Patel",
    lobbyistTitle: "VP, Regulatory Affairs",
    organization: "Bell Canada",
    type: "In-house",
    registrationNo: "PP8201-20250901035500",
    initialFilingDate: "2025-09-01",
    lastAmendmentDate: "2025-12-05",
    clientDescription: "Canada's largest telecommunications company providing wireless, internet, TV, and media services.",
    parentCorporation: "BCE Inc. (TSX: BCE)",
    targetMinisterOffices: ["Office of the Minister of Economic Development Job Creation and Trade", "Office of the Minister of Red Tape Reduction"],
    targetMinistries: ["Ministry of Economic Development Job Creation and Trade", "Ministry of Red Tape Reduction"],
    targetMPPs: [],
    targetAgencies: ["Ontario Centre of Innovation"],
    lobbiedPerson: "Stephen Lecce",
    lobbiedTitle: "Minister of Economic Development",
    lobbiedOrg: "Ministry of Economic Development, Job Creation and Trade",
    subjectMatters: ["Economic development and trade", "Science and technology", "Industry", "Consumer protection"],
    subjectMatter: "Technology",
    activityTypes: ["Policy and/or program", "Regulation", "Bill or resolution"],
    lobbyingGoals: "Advocate for streamlined telecommunications infrastructure permitting, influence digital economy policy, oppose overly broad right-to-repair mandates that could compromise network security, and secure 5G expansion incentives.",
    topic: "Telecom regulation — 5G expansion and digital policy",
    communicationTechniques: ["Arranging Meetings", "Attending Meetings", "Presentations", "Written Communication"],
    formerPublicOffices: ["None"],
    receivedGovFunding: false,
  ...
  {
    lobbyistName: "Tyler Grant",
    lobbyistTitle: "Director, Government Relations",
    organization: "Rogers Communications",
    type: "In-house",
    registrationNo: "PP8305-20251001035600",
    initialFilingDate: "2025-10-01",
    lastAmendmentDate: "2025-11-20",
    clientDescription: "Major Canadian telecommunications and media company providing wireless, cable, and internet services.",
    parentCorporation: "Rogers Communications Inc. (TSX: RCI.B)",
    targetMinisterOffices: ["Office of the Minister of Economic Development Job Creation and Trade", "Office of the Minister of Red Tape Reduction", "Office of the Minister of Finance"],
    targetMinistries: ["Ministry of Economic Development Job Creation and Trade", "Ministry of Red Tape Reduction", "Ministry of Finance"],
    targetMPPs: ["Member for Don Valley West"],
    targetAgencies: [],
    lobbiedPerson: "Stephen Lecce",
    lobbiedTitle: "Minister of Economic Development",
    lobbiedOrg: "Ministry of Economic Development, Job Creation and Trade",
    subjectMatters: ["Economic development and trade", "Science and technology", "Industry", "Consumer protection"],
    subjectMatter: "Technology",
    activityTypes: ["Policy and/or program", "Regulation", "Grant/contribution"],
    lobbyingGoals: "Secure preferential spectrum and infrastructure access for 5G rollout, influence Buy Ontario procurement rules to favour domestic telecom providers, advocate for reduced regulatory burden on network expansion, and lobby against consumer protection measures that limit data pricing flexibility.",
    topic: "Telecom policy — spectrum access and 5G infrastructure",
    communicationTechniques: ["Arranging Meetings", "Attending Meetings", "Telephone Calls", "Presentations", "Written Communication"],
    formerPublicOffices: ["Employee in office of a minister"],
    receivedGovFunding: false,
